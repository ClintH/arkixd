...
![Attachables](./aljundi-attachables.jpg)

Different principles of math and physics can be toyed with.

<figure class="imageSet">
![Circular](./aljundi-circular.gif)
![Circular](./aljundi-circular2.gif)
![Linear](./aljundi-linear.gif)
![Rotation](./aljundi-rotation.gif)
![Oscillation](./aljundi-oscillating.gif)
</figure>
