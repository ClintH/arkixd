...
![Analysis](./hultman-1.jpg 'Analysis')
![Ideation session with other designers](./hultman-2.jpg 'Ideation session with other designers')
...
![Key elements of the concept](./hultman-3.png 'Key elements of the concept')
![](./hultman-4a.png)
![](./hultman-4b.png)
![](./hultman-4c.png)
...
![Audio guide speakers](./hultman-0.jpg 'Audio guide speakers')
